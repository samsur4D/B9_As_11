...

{
				  ...
				  {remoteJobs.map((job) => (
					<div
					  key={job._id}
					  className="relative  mt-5 rounded-3xl bg-[#fab1a0]  flex flex-col justify-between  p-6 divide-y xl:flex-row xl:divide-y-0 xl:divide-x dark:bg-gray-50 dark:text-gray-800 dark:divide-gray-300"
					>
