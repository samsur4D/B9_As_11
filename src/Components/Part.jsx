...
const Part = () => {
    return (
        <div className='mt-5 '>
        <h1 className='text-xl'> <span className='text-2xl text-red-500 font-bold'>Only Part-time jobs</span> are listed below</h1>
        <div className="relative ml-72 mt-5 rounded-3xl bg-gray-200  flex flex-col max-w-2xl p-6 divide-y xl:flex-row xl:divide-y-0 xl:divide-x dark:bg-gray-50 dark:text-gray-800 dark:divide-gray-300">
