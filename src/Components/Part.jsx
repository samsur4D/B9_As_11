...
const Part = () => {
    return (
        ...
        <div className="relative bg-gray-300  flex flex-col max-w-2xl p-6 divide-y xl:flex-row xl:divide-y-0 xl:divide-x dark:bg-gray-50 dark:text-gray-800 dark:divide-gray-300">
