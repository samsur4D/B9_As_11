...
// 		<div className=" space-y-1 ml-0 md:ml-60 lg:ml-0">
...
// 	</div>
// 	<button className=' px-4 py-4 md:px-4 md:py-4 lg:px-2 lg:py-0 underline text-blue-600 font-semibold  rounded-2xl'>Viewl Details</button>
