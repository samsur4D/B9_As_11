...
export default function App() {
  return (
    <>
      <Swiper navigation={true} modules={[Navigation]}  autoplay={{ delay: 2000, disableOnInteraction: false }}
          ...
          <div className="w-full h-[700px] rounded-xl">
            <div className="relative w-full lg:w-full">
              <img
                ...
                src="https://i.ibb.co/NWVm5sH/marvin-meyer-SYTO3xs06f-U-unsplash-1.webp"
                alt=""
              />
            </div>
          ...
          <div className="w-full h-[700px] rounded-xl">
            <div className="relative w-[450px] lg:w-full">
              <img
                ...
                src="https://i.ibb.co/MGTnjFz/austin-distel-rxp-Th-Owu-Vg-E-unsplash.webp"
                alt=""
              />
            </div>
        ...
        <SwiperSlide className="rounded-xl">
          <div className="w-full h-[700px] rounded-xl">
            <div className="relative w-[450px] lg:w-full">
              <img
                className="  h-[500px] md:h-[600px] lg:h-[900px] lg:w-full"
                src="https://i.ibb.co/zxMv0Qp/lycs-architecture-U2-BI3-GMn-SSE-unsplash.webp"
                alt=""
              />
            </div>
        ...
        <SwiperSlide className="rounded-xl">
          <div className="w-full h-[700px] rounded-xl">
            <div className="relative w-[450px] lg:w-full">
              <img
                className="  h-[500px] md:h-[600px] lg:h-[900px] lg:w-full"
                src="https://i.ibb.co/B3zrB26/benjamin-child-GWe0dl-VD9e0-unsplash.webp"
                alt=""
              />
            </div>
