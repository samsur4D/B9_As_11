...
import one from '../../assets/images/one (1).jfif'
import two from '../../assets/images/one (2).jfif'
import three from '../../assets/images/one (3).jfif'
import four from '../../assets/images/one (4).jfif'
...
const Exsthree = () => {
    return (
        <div className='mt-24 mb-24'>
               ...
               {/* ------------------------------ */}
               <div data-aos="zoom-in-right" className='flex items-center justify-center gap-3'>
               ...
               {/* --------------------------------- */}
               <div data-aos="zoom-in-down" className='flex items-center justify-center gap-3'>
