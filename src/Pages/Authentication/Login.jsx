...
{/* -------------------------------------------------------------------------------- */}
 ...
 <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8  ">
	...
	<div className="my-6 space-y-4">
		<button aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1  focus:dark:ring-violet-600">
	...
	<form noValidate="" action="" className="space-y-8">
		<div className="space-y-4">
			...
			<div className="space-y-2">
				...
				<input type="password" name="password" id="password" placeholder="*****" className="w-full px-3 py-2 border rounded-md focus:dark:border-violet-600" />
			</div>
		</div>
